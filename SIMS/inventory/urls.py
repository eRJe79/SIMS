...
from .views import (
    ...
    GroupAssemblyCreate, GroupAssemblyListView, show_groupassembly, update_group_assembly, show_groupassembly_history,
...
urlpatterns = [
    ...
    path('group_assembly/group_assembly_history/<primary_key>', show_groupassembly_history, name='groupassembly-history'),
