...
class Equivalence(models.Model):
    name = models.CharField(max_length=120, null=True, blank=True)
    pieceeq_1 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_1', null=True, blank=False)
    pieceeq_2 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_2',  null=True, blank=False)
    pieceeq_3 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_3',  null=True, blank=False)
    pieceeq_4 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_4',  null=True, blank=False)
    pieceeq_5 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_5',  null=True, blank=False)
    pieceeq_6 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_6',  null=True, blank=False)
    pieceeq_7 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_7',  null=True, blank=False)
    pieceeq_8 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_8',  null=True, blank=False)
    pieceeq_9 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_9',  null=True, blank=False)
    pieceeq_10 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_10',  null=True, blank=False)
    pieceeq_11 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_11',  null=True, blank=False)
    pieceeq_12 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_12',  null=True, blank=False)
    pieceeq_13 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_13',  null=True, blank=False)
    pieceeq_14 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_14',  null=True, blank=False)
    pieceeq_15 = models.ForeignKey(Piece, on_delete=models.CASCADE, related_name='pieceeq_15',  null=True, blank=False)
    # This is a default return method to access Piece
    def __str__(self):
        """String for representing the Model object."""
        return self.name
